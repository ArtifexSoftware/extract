...
static int extract_docx_char_append_string(extract_astring_t* content, char* text)
{
    return extract_astring_cat(content, text);
}

static int extract_docx_char_append_stringf(extract_astring_t* content, char* format, ...)
{
    char* buffer = NULL;
    int e;
    va_list va;
